...
const LOCALES = {
  en: {
    ...
    // commands.js (batch 1 handlers)
    no_active_task: 'No active task to stop.',
    stream_stopped: '⚡ Stopped. You can continue this session.',
    cancel_unavailable: 'Cancel function unavailable.',
    title_set: 'Title set to',
    title_current: 'Current title',
    title_change_hint: 'Use `/title <name>` to change it.',
    retry_failed: 'Retry failed: ',
    undo_failed: 'Undo failed: ',
    undid_n_messages: 'Undid',
    ...
    usage_settings_tip: '_Tip: toggle "Show token usage" in Settings to see this in every message._',
  },
  ...
  es: {
    ...
    bg_error_multi: (count) => `${count} sessions have encountered an error`,
    // commands.js (batch 1 handlers)
    no_active_task: 'No hay ninguna tarea activa para detener.',
    stream_stopped: '⚡ Detenido. Puedes continuar esta sesión.',
    cancel_unavailable: 'Función de cancelación no disponible.',
    title_set: 'Título establecido a',
    title_current: 'Título actual',
    title_change_hint: 'Usa `/title <nombre>` para cambiarlo.',
    retry_failed: 'Reintento fallido: ',
    undo_failed: 'Deshacer falló: ',
    undid_n_messages: 'Deshecho',
    undid_messages_suffix: 'mensaje(s).',
    status_load_failed: 'Error al cargar el estado: ',
    usage_load_failed: 'Error al cargar el uso: ',
    status_heading: '📊 Estado de la sesión',
    status_session_id: 'ID de sesión',
    status_title: 'Título',
    status_model: 'Modelo',
    status_workspace: 'Espacio de trabajo',
    status_personality: 'Personalidad',
    status_messages: 'Mensajes',
    status_agent_running: 'Agente en ejecución',
    status_yes: 'Sí ⚡',
    status_no: 'No',
    usage_heading: '📈 Uso de Tokens',
    usage_input_tokens: 'Tokens de entrada',
    usage_output_tokens: 'Tokens de salida',
    usage_total: 'Total',
    usage_estimated_cost: 'Costo estimado',
    usage_unknown: '(desconocido)',
    usage_default_model: '(predeterminado)',
    usage_personality_none: '(ninguno)',
    usage_settings_tip: '_Consejo: activa "Mostrar uso de tokens" en Configuración para verlo en cada mensaje._',
  },
  ...
  de: {
    ...
    // commands.js (batch 1 handlers)
    no_active_task: 'Keine aktive Aufgabe zum Stoppen.',
    stream_stopped: '⚡ Gestoppt. Du kannst diese Sitzung fortsetzen.',
    cancel_unavailable: 'Abbrechen-Funktion nicht verfügbar.',
    title_set: 'Titel gesetzt auf',
    title_current: 'Aktueller Titel',
    title_change_hint: 'Verwende `/title <Name>`, um ihn zu ändern.',
    retry_failed: 'Wiederholung fehlgeschlagen: ',
    undo_failed: 'Rückgängig fehlgeschlagen: ',
    undid_n_messages: 'Rückgängig gemacht',
    undid_messages_suffix: 'Nachricht(en).',
    status_load_failed: 'Status konnte nicht geladen werden: ',
    usage_load_failed: 'Nutzung konnte nicht geladen werden: ',
    status_heading: '📊 Sitzungsstatus',
    status_session_id: 'Sitzungs-ID',
    status_title: 'Titel',
    status_model: 'Modell',
    status_workspace: 'Workspace',
    status_personality: 'Persönlichkeit',
    status_messages: 'Nachrichten',
    status_agent_running: 'Agent läuft',
    status_yes: 'Ja ⚡',
    status_no: 'Nein',
    usage_heading: '📈 Token-Nutzung',
    usage_input_tokens: 'Eingabe-Tokens',
    usage_output_tokens: 'Ausgabe-Tokens',
    usage_total: 'Gesamt',
    usage_estimated_cost: 'Geschätzte Kosten',
    usage_unknown: '(unbekannt)',
    usage_default_model: '(Standard)',
    usage_personality_none: '(keine)',
    usage_settings_tip: '_Tipp: Aktiviere "Token-Nutzung anzeigen" in den Einstellungen, um dies in jeder Nachricht zu sehen._',
  },
  ...
  zh: {
    ...
    // commands.js (batch 1 handlers)
    no_active_task: '当前没有运行任务。',
    stream_stopped: '⚡ 已停止。你可以继续会话。',
    cancel_unavailable: '取消功能不可用。',
    title_set: '标题已设为',
    title_current: '当前标题',
    title_change_hint: '使用 `/title <名称>` 修改。',
    retry_failed: '重试失败：',
    undo_failed: '撤销失败：',
    undid_n_messages: '已撤销',
    undid_messages_suffix: '条消息。',
    status_load_failed: '获取状态失败：',
    usage_load_failed: '获取用量失败：',
    status_heading: '📊 会话状态',
    status_session_id: '会话 ID',
    status_title: '标题',
    status_model: '模型',
    status_workspace: '工作目录',
    status_personality: '人格',
    status_messages: '消息数',
    status_agent_running: '代理运行中',
    status_yes: '是 ⚡',
    status_no: '否',
    ...
    usage_total: '总计',
    usage_estimated_cost: '预估成本',
    usage_unknown: '(未知)',
    usage_default_model: '(默认)',
    usage_personality_none: '(无)',
    usage_settings_tip: '_提示：在设置中切换"显示 Token 用量"可在每条消息中看到。_',
  },
  ...
  'zh-Hant': {
    ...
    tab_profiles: '\u914d\u7f6e',
    // commands.js (batch 1 handlers)
    no_active_task: '目前沒有執行中的任務。',
    stream_stopped: '⚡ 已停止。你可以繼續此會話。',
    cancel_unavailable: '取消功能不可用。',
    title_set: '標題已設為',
    title_current: '目前標題',
    title_change_hint: '使用 `/title <名稱>` 修改。',
    retry_failed: '重試失敗：',
    undo_failed: '復原失敗：',
    undid_n_messages: '已復原',
    ...
    status_title: '標題',
    status_model: '模型',
    status_workspace: '工作目錄',
    status_personality: '人格',
    status_messages: '訊息數',
    status_agent_running: '代理執行中',
    status_yes: '是 ⚡',
    status_no: '否',
    usage_heading: '📈 Token 用量',
    ...
    usage_total: '總計',
    usage_estimated_cost: '預估成本',
    usage_unknown: '(未知)',
    usage_default_model: '(預設)',
    usage_personality_none: '(無)',
    usage_settings_tip: '_提示：在設定中切換「顯示 Token 用量」可在每則訊息中看到。_',
  },
};
